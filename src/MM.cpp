...
void MM<T>::naiveGEMM() {
    ...
    std::cout << "[MM] Running naiveGEMM (prec "<<sizeof(T)*8.0<<" bits)"<<std::endl;;
    Profiler profiler;
...
void MM<T>::tiledGEMM(){
    // Example dummy implementation (matrix multiply)
    std::cout << "[MM] Running tiledGEMM (prec "<<sizeof(T)*8.0<<" bits)"<<std::endl;;
...
void MM<T>::naiveOpenMPGEMM() {
    // Example dummy implementation (matrix multiply)
    std::cout << "[MM] Running naiveOpenMPGEMM (prec "<<sizeof(T)*8.0<<" bits)"<<std::endl;;
    Profiler profiler;
...
void MM<T>::tiledOpenMPGEMM(){
    // Example dummy implementation (matrix multiply)
    std::cout << "[MM] Running tiledOpenMPGEMM (prec "<<sizeof(T)*8.0<<" bits)"<<std::endl;;
